...
/// data : [{"id":"1","name":"Abhishek ","email":"Abhi123@gmail.com","mobile":"1234567890","qualification":"MBBS","profession":"Medicine","experience":"5+ years","state":"Balé (Boromo)","address":"Paris, France","latitude":"","longitude":"","fees_condition":"500","referral_code":"01","fcm_id":"","profile_image":"652e199b70888.jpg","certificate_image":"652e199b71884.jpg","license_image":"652e199b72992.jpg","gender":"male","about":"i am abhishek vyas","otp":"9847","verify_otp":"1","status":"1","status_on_of":"0","rating":"4","rating_count":"2","date":"2023-10-17","time":"19:10"}]

Populardoctor populardoctorFromJson(String str) => Populardoctor.fromJson(json.decode(str));
String populardoctorToJson(Populardoctor data) => json.encode(data.toJson());
class Populardoctor {
  Populardoctor({
      String? result, 
      String? msg, 
  ...
  Populardoctor.fromJson(dynamic json) {
    _result = json['result'];
    _msg = json['msg'];
    if (json['data'] != null) {
      _data = [];
  ...
  String? _msg;
  List<Data>? _data;
Populardoctor copyWith({  String? result,
  String? msg,
  List<Data>? data,
}) => Populardoctor(  result: result ?? _result,
  msg: msg ?? _msg,
  data: data ?? _data,
);
...
/// referral_code : "01"
/// fcm_id : ""
/// profile_image : "652e199b70888.jpg"
/// certificate_image : "652e199b71884.jpg"
/// license_image : "652e199b72992.jpg"
/// gender : "male"
/// about : "i am abhishek vyas"
/// otp : "9847"
/// verify_otp : "1"
/// status : "1"
/// status_on_of : "0"
