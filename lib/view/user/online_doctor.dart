...
class Online_doctor_all extends StatefulWidget {
  const Online_doctor_all({super.key});

  @override
  State<Online_doctor_all> createState() => _Online_doctor_allState();
}

class _Online_doctor_allState extends State<Online_doctor_all> {
