...
import 'package:suivivital/view/user/form/thearpy/therapy_controller.dart';
import '../../../../utils/color.dart';
import '../../api_controller_user/get_dropdown_list.dart';
import '../../api_controller_user/signup_api.dart';
import '../../api_controller_user/signup_form3.dart';
import '../medicines/medicinesuse.dart';
...
class _Form3State extends State<Form3> {
  ...
  final signup_user_form3_api = Get.put(Signup_form_3_api());
      ...
      body: SingleChildScrollView(
        child: Padding(
          ...
          child: Column(children: [
                  ...
                  child: Obx(
                    () => Container(
                      ...
                      decoration: BoxDecoration(
                          ...
                          borderRadius: BorderRadius.circular(10),
                          border: Border.all(color: colors.geryq1, width: 1)),
                      child: const Text("multiple daily injection"),
                    ),
                  ),
                )
              ],
                              ...
                              GestureDetector(
                                ...
                                child: Container(
                                  ...
                                  decoration: BoxDecoration(
                                      ...
                                      border: Border.all(
                                          color:
                                              therapy_contoller.multiplday == 0
                                                  ? colors.logosec
                                                  : colors.geryq1,
                                          width: 2)),
                              ...
                              GestureDetector(
                                ...
                                child: Container(
                                  ...
                                  decoration: BoxDecoration(
                                      ...
                                      border: Border.all(
                                          color:
                                              therapy_contoller.multiplday == 1
                                                  ? colors.logosec
                                                  : colors.geryq1,
                                          width: 2)),
                              ...
                              GestureDetector(
                                ...
                                child: Container(
                                  ...
                                  decoration: BoxDecoration(
                                      ...
                                      border: Border.all(
                                          color:
                                              therapy_contoller.multiplday == 2
                                                  ? colors.logosec
                                                  : colors.geryq1,
                                          width: 2)),
            ...
            Obx(
              () => signup_user_form3_api.isloading == true
                  ? const Center(
                  ...
                  : Container(
                      ...
                      child: ElevatedButton(
                          ...
                          onPressed: () async {
                            signup_user_form3_api.loader();
                            therapy_contoller.noninsulin == 0
                                ? await signup_user_form3_api
                                    .signup_user_form3_0(
                            ...
                            signup_user_form3_api.loader_fa();
